...
def show_pred(all_y_true, all_predict_values, horizon, save_name):
    ...
    with open(f'./output/{save_name}/result/ele.csv', 'a', encoding='utf-8', newline='') as fp:
        # 写
    ...
    with open(f'./output/{save_name}/result/cooling.csv', 'a', encoding='utf-8', newline='') as fp:
        # 写
        writer = csv.writer(fp)
        # 设置第一行标题头
        writer.writerow(header)
    ...
    with open(f'./output/{save_name}/result/heating.csv', 'a', encoding='utf-8', newline='') as fp:
        # 写
        writer = csv.writer(fp)
        # 设置第一行标题头
        writer.writerow(header)
